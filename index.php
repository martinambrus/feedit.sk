...
?>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6Le5VLoZAAAAALoOSJNdm3DYDMkt4fwKPc24dn99"></script>
    <script type="application/javascript">
      ...
      $('#reg_form').on('submit', function() {
        ...
        grecaptcha.ready(function() {
          grecaptcha
            .execute('6Le5VLoZAAAAALoOSJNdm3DYDMkt4fwKPc24dn99', {action: 'submit'})
            .then(function(token) {
              // verify Re-Captcha
