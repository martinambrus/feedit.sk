...
<ion-slide>
  <ion-grid class="ion-no-padding">
    ...
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
        <img src="help/wizard-mobile-full/2.gif" />
      </ion-col>
    </ion-row>
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
...
<ion-slide>
  <ion-grid class="ion-no-padding">
    ...
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
        <img src="help/wizard-mobile-full/3.gif" />
      </ion-col>
    </ion-row>
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
...
<ion-slide>
  <ion-grid class="ion-no-padding">
    ...
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
        <img src="help/wizard-mobile-full/4.gif" />
      </ion-col>
    </ion-row>
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
...
<ion-slide>
  <ion-grid class="ion-no-padding">
    ...
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
        <img src="help/wizard-mobile-full/5.gif" />
      </ion-col>
    </ion-row>
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
...
<ion-slide>
  <ion-grid class="ion-no-padding">
    ...
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
        <img src="help/wizard-mobile-full/6.gif" />
      </ion-col>
    </ion-row>
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
...
<ion-slide>
  <ion-grid class="ion-no-padding">
    ...
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
        <img src="help/wizard-mobile-full/7.gif" />
      </ion-col>
    </ion-row>
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
...
<ion-slide>
  <ion-grid class="ion-no-padding">
    ...
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
        <img src="help/wizard-mobile-full/8.gif" />
      </ion-col>
    </ion-row>
    <ion-row class="ion-text-center">
      <ion-col class="ion-no-padding">
