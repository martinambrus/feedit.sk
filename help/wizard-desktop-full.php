...
<ion-slide>
  <img src="help/wizard-desktop-full/2.gif" class="right10px" />
  <ion-text>
...
<ion-slide>
  <img src="help/wizard-desktop-full/3.gif" class="right10px" />
  <ion-text>
    <h2><?php echo $lang['Simple Articles Training']; ?></h2>
    <ul class="ion-text-left">
      <li>
        <?php echo $lang['click the']; ?> <ion-badge color="success" class="simple-mode-ignore"><ion-icon name="checkmark-sharp"></ion-icon></ion-badge> <?php echo $lang['badge to Like an article or']; ?> <ion-badge color="danger" class="simple-mode-ignore"><ion-icon name="close-sharp"></ion-icon></ion-badge> <?php echo $lang['badge to Dislike an article']; ?>
      </li>
      <li>
      ...
      <li>
        <?php echo $lang['click any of the badges or bottom page buttons again on trained articles to un-train them']; ?>
      </li>
      <li>
...
<ion-slide>
  <img src="help/wizard-desktop-full/4.gif" class="right10px" />
  <ion-text>
    <h2><?php echo $lang['Detailed Articles Training']; ?></h2>
    <ul class="ion-text-left">
      <li>
        <?php echo $lang['click the'];?> <ion-badge><ion-icon name="bar-chart-sharp" class="ion-float-left"></ion-icon><ion-text><small> <?php echo $lang['train']; ?></small></ion-text></ion-badge> <?php echo $lang['badge to enter a detailed training mode']; ?>
      </li>
      <li>
...
<ion-slide>
  <img src="help/wizard-desktop-full/5.gif" class="right10px" />
  <ion-text>
...
<ion-slide>
  <img src="help/wizard-desktop-full/6.gif" class="right10px" />
  <ion-text>
    ...
    <ul class="ion-text-left">
      ...
      <li>
        <?php echo $lang['a new'] . ' &quot;' . $lang['labels'] . '&quot; ' . $lang['badge will become visible for every Feed with at least a single label, as well as a dropdown with all labels next to the Feed\'s title (badge titled labels on top of page)'] ; ?>
      </li>
      <li>
...
<ion-slide>
  <img src="help/wizard-desktop-full/7.gif" class="right10px" />
  <ion-text>
...
<ion-slide>
  <img src="help/wizard-desktop-full/8.gif" class="right10px" />
  <ion-text>
